...
def evolve(pop, target, itens, retain=0.2, random_select=0.05, mutate=0.01):
    'Tabula cada individuo e o seu fitness'
    graded = [ (fitness(x, itens, target), x) for x in pop]
    # print("1: ", graded)
    # print("2: ", sorted(graded, reverse=True))
    'Ordena pelo fitness os individuos - maior->menor'
    graded = [ x[1] for x in sorted(graded, reverse=True)]  #inverter a ordem do 'sorted'
    # print(graded)
    # exit()
